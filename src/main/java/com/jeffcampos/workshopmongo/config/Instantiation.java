...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("10/08/2021"), "Partiu viagem", "Vou viajar para São Rock", maria);
		Post post2 = new Post(null, sdf.parse("11/08/2021"), "Bundinha", "Acordei em São Rock", maria);
